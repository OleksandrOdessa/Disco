...
***************************************************************************** */
    ...
    function fixTop() {
        if (window.pageYOffset > 1) header.classList.add("sticky-header"); else header.classList.remove("sticky-header");
    }
    //! Валидация номера телефона
        let phoneInput = document.querySelector(".popup__phone");
